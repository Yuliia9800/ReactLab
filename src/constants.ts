export const mockedCoursesList: any[] = [
	{
    ...
    1500s, when an unknownprinter took a galley of type and scrambled it to make a type specimen book.`,
...
export const mockedAuthorsList: any[] = [
	{
...
export const SEARCH_INPUT_PLACEHOLDER = 'Enter course name or id...';

export const TITLE_INPUT_LABEL = 'Title';
export const TITLE_INPUT_PLACEHOLDER = 'Enter title...';

export const DESCRIPTION_INPUT_LABEL = 'Description';
export const DESCRIPTION_INPUT_PLACEHOLDER = 'Enter description...';

export const AUTHOR_NAME_INPUT_LABEL = 'Add author name';
export const AUTHOR_NAME_INPUT_PLACEHOLDER = 'Enter author name...';

export const DURATION_INPUT_LABEL = 'Duration';
export const DURATION_INPUT_PLACEHOLDER = 'Enter duration in minutes...';
